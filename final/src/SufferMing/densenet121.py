...
#     x = BatchNormalization(epsilon=eps, axis=concat_axis, name='conv1_bn')(x)
    x = GroupNormalization(epsilon=eps, axis=concat_axis, name='conv1_gn')(x)
    ...
    x = GroupNormalization(epsilon=eps, axis=concat_axis, name='conv'+str(final_stage)+'_blk_gn')(x)
...
if __name__ == '__main__':
    ...
    img_rows, img_cols = 600,800 # Resolution of inputs
    channel = 3
    num_classes = 14
    batch_size = 16
    nb_epoch = 10
